...
const Info = () => {
  return (
    <div className='mx-6 mt-12 md:mt-24 md:container md:mx-auto md:px-4'>
      <div className='bg-primary px-6 py-8 md:px-12 md:py-8 grid grid-cols-12 place-items-center gap-4 md:gap-12 rounded-xl relative overflow-hidden'>
        <Gradient
          rotate='-rotate-90'
