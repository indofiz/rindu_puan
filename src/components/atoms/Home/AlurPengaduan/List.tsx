...
const List: React.FC<ListPengajuanProps> = ({ title, image, desc }) => {
  return (
    <div className="flex flex-1 items-center gap-8 md:gap-4 md:items-start bg-white border border-pink-500 rounded-lg py-3 px-6 md:py-5 md:shadow">
      <img src={image} alt="" className="w-17 md:w-12 aspect-square" />
