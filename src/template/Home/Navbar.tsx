...
const Navbar: React.FC<NavbarProps> = (props) => {
  ...
  return (
    <div className='flex px-6 lg:px-12 py-2 md:py-6 lg:py-8 justify-between items-center md:container md:mx-auto'>
      ...
      >
        <ul className='flex gap-12 flex-col md:flex-row text-white md:text-gray-600 md:text-sm md:gap-8 font-normal px-5'>
          <li>
            <NavLink
              className={({ isActive }) =>
                isActive
                  ? 'text-black md:text-primary font-semibold border-b-2 border-black md:border-primary'
                  : ''
              }
              to='/'
            >
          ...
          <li>
            <NavLink to='/faq' className='md:hover:text-primary'>
              FAQ
            </NavLink>
          </li>
          <li>
