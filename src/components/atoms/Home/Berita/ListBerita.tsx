...
const ListBerita: React.FC<ListBeritaFace> = ({ item, index }) => {
  return (
    <div className="relative py-4 md:p-4 md:pb-8 flex md:flex-col gap-5 justify-start md:col-span-3 border-b-2 border-gray-200 md:border md:border-gray-200 md:shadow md:bg-white md:hover:bg-white/80 md:hover:shadow-none md:rounded-2xl md:relative">
      ...
      <img
        src={item?.gambar}
        className="rounded-2xl ml-auto md:rounded-xl w-32 md:w-full max-h-52 object-cover"
        alt=""
      />
    </div>
  );
